...
\begin{document}
\name{Jonas Stettner}
\tagline{Graduate Student in Social and Economic Data Science}
...
\cvevent{Student Assistant}{University of Konstanz}{February 2022 - ongoing}{Konstanz}

\begin{itemize}
\item Programming online experiments with OTree
\item Setting up servers for online experiments
\item Working with Pupil Labs Core Eyetracker
\end{itemize}

\divider


\cvevent{Guest Scientist}{Potsdam Institute for Climate Impact Research}{December 2020 - August 2021}{Potsdam}

\begin{itemize}
\item Writing Research Reports
\item Presenting Methods
\end{itemize}

\divider


\cvevent{Intern}{Potsdam Institute for Climate Impact Research}{October 2020 - November 2021}{Potsdam}
